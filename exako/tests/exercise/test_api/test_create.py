...
from exako.apps.exercise.api.schema import ExerciseSchemaView
from exako.apps.exercise.models import Exercise, ExerciseLevel
from exako.apps.term.constants import Level
...
def test_create_exercise_create_term_lexical_value_level(
    client, generate_payload, token_header, exercise_factory
):
    term = TermFactory()
...
def test_create_exercise_create_term_lexical_term_ref_level(
    client, generate_payload, token_header, exercise_factory
):
    term = TermFactory()
    term_lexical = TermLexicalFactory(value=None, term_value_ref=term)
    TermDefinitionFactory(
        level=Level.ADVANCED,
        term=term,
    )
