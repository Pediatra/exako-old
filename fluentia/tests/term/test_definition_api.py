...
from fluentia.apps.term.api.schema import (
    TermDefinitionTranslationView,
    TermDefinitionView,
)
from fluentia.apps.term.constants import Language, Level, PartOfSpeech
from fluentia.apps.term.models import TermDefinition, TermDefinitionTranslation
...
def test_get_term_definition_translation(client):
    translation = TermDefinitionTranslationFactory(language=Language.PORTUGUESE)
